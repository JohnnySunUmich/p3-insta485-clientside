...
//         setData(data);
//         setInfoBar({
//           postLink: data.postShowUrl,
//           timeCreated: data.created,
//           poster: data.owner,
//           pfp: data.ownerImgUrl,
//           posterLink: data.ownerShowUrl,
//         });
//         setLikes({
//           userLiked: data.likes.lognameLikesThis,
//           num: data.likes.numLikes,
//           url: data.likes.url,
//         });
//       }
//       return () => {
